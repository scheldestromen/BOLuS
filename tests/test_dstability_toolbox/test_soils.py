...
class TestSoilCollection(TestCase):
    ...
    def test_from_list(self):
        """Test creating a soil collection from a list of dictionaries"""
        soils_dicts = [
            {
                "name": "soil1",
            ...
            {
                "name": "soil2",
                "unsaturated_weight": 17.0,
                "saturated_weight": 19.0,
                "strength_model_above": "Shansep",
                "strength_model_below": "Shansep",
                "c": 6.0,
                "phi": 35.0,
    ...
    def test_from_list_missing_keys(self):
        """Test that creating a collection from a list of dictionaries with missing keys raises an error"""
        soils_dicts = [
            {
                "name": "soil1",
            }
