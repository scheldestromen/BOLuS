...
class TestGetFilesByExtension(TestCase):
    ...
    def test_get_files_by_extension(self):
        ...
        self.assertIn(
            {"name": self.test_file1.name, "path": str(self.test_file1)}, files
        )
        self.assertIn(
            {"name": self.test_file2.name, "path": str(self.test_file2)}, files
        )
    ...
    def test_get_files_by_extension_with_subdir(self):
        ...
        self.assertIn(
            {"name": self.test_file3.name, "path": str(self.test_file3)}, files
        )
